...
/***/ function(module, exports, __webpack_require__) {
	...
	var FixedDataTable = React.createClass({
	  ...
	  componentWillReceiveProps: function componentWillReceiveProps( /*object*/nextProps) {
	    ...
	    if (scrollToRow !== void 0 && scrollToRow !== null && scrollToRow !== this.props.scrollToRow) {

	      this._rowToScrollTo = scrollToRow;
	    } else if (scrollTop !== void 0 && scrollTop !== null && scrollTop !== this.props.scrollTop) {
	      this._YPosToScrollTo = scrollTop;
	    }

	    var scrollToColumn = nextProps.scrollToColumn;
	    var scrollLeft = nextProps.scrollLeft;
	    if (scrollToColumn !== void 0 && scrollToColumn !== null && scrollToColumn !== this.props.scrollToColumn) {

	      this._columnToScrollTo = scrollToColumn;
	    } else if (scrollLeft !== void 0 && scrollLeft !== null && scrollLeft !== this.props.scrollLeft) {
